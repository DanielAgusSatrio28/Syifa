function startFarewell() {
    ...
    // Ganti pesan
    message.textContent = "DIBACA WOI SEKUM JR";
    subMessage.textContent = "Terima kasih ya princess Syifa, makasi uda mau nemenin gua jadi sekum bersama anis, meskipun gua ngerasa lu ada something sama yg lain cuman gapapa jangan dipikirin. let it go aja kerjain sesuai tupoksi lu jadi sekretaris ya !!";
